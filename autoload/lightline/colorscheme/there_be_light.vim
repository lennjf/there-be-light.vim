...
let g:lightline#colorscheme#there_be_light#faithful = get(g:, 'lightline#colorscheme#there_be_light#faithful', 1)

if g:lightline#colorscheme#there_be_light#faithful == 1
...
let g:lightline#colorscheme#there_be_light#palette = lightline#colorscheme#flatten(s:p)
